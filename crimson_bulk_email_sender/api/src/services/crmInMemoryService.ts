...
// Leads
const getLeads = async (tenantId, query: any = {}) => {
...
// Contacts
const getContacts = async (tenantId, query: any = {}) => {
...
// Companies
const getCompanies = async (tenantId, query: any = {}) => {
...
// Deals
const getDeals = async (tenantId, query: any = {}) => {
...
// Tasks
const getTasks = async (tenantId, query: any = {}) => {
...
// Follow Ups
const getFollowUps = async (tenantId, query: any = {}) => {
...
// Activities
const getActivities = async (tenantId, query: any = {}) => {
...
// Orders
const getOrders = async (tenantId, query: any = {}) => {
...
const updateOrder = async (id, tenantId, data, userId) => {
  ...
  if (data.status === 'Completed') {
    ...
    if (totalPaid < order.totalAmount - 0.01) {
      throw new Error(`Cannot mark Completed: order,. Payment is not fully received. (Paid: ₹${totalPaid.toFixed(2)} / Grand Total: ₹${order.totalAmount.toFixed(2)})`);
    }
  }
...
// Payments
const getPayments = async (tenantId, query: any = {}) => {
...
// Expenses
const getExpenses = async (tenantId, query: any = {}) => {
